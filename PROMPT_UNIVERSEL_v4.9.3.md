# 🎬 PROMPT UNIVERSEL DE PRODUCTION LYRICS — v4.9.3 (badge DSKY✓ haut-centre · CTA 2 s · partage mi-vidéo · stickers cœurs ❤️💞 · teaser vidéo autonome · chartes P/S · lisibilité 4 couches)
...
## 🏷 5. RÈGLE D'OR — BADGE / CTA / ENGAGEMENT (v4.9.3 — stickers cœurs)
...
### 5.2 Stickers CTA « Like / S'abonner / Commenter » — 2 premières secondes (OBLIGATOIRE — v4.9.3 : style CŒURS MIGNONS)
- **NOUVEAU STYLE v4.9.3 (demande artiste)** : les stickers CTA ne sont plus des icônes vectorielles classiques — c'est une **famille de stickers « cœurs mignons »** générée UNE SEULE FOIS (fond transparent), cohérente charte Daïsky (cyan/ambre, léger glow, style kawaii-seinen propre), réutilisée sur TOUS les projets :
  - **Like = ❤️💞** : **deux cœurs** — un grand cœur plein rouge-rose + un cœur scintillant/entouré de sparkles (rendu « ❤️💞 »), glow doux.
  - **Commenter = variante mignonne** : petite bulle de dialogue kawaii **contenant un petit cœur**, clin d'œil aux ❤️ du like.
  - **S'abonner = variante mignonne** : petite cloche kawaii **avec un cœur en breloque** (ou un cœur qui bat à la place du battant).
  - **Partager = variante mignonne** (liée à §5.3) : petit orbe/cœur ailé ou flèche de partage stylisée avec traînée de mini-cœurs.
- Fichiers : `assets/icons/stickers/like_hearts.png`, `comment_cute.png`, `subscribe_cute.png`, `share_cute.png` (PNG détourés). Si absents, les générer par IA (prompt : `cute kawaii sticker, glossy heart style, cyan and amber glow accents, dark background, no text, no watermark`) puis détourer proprement.
- Sur **le lyrics ET le teaser** : la rangée **❤️💞 Like · 🛎(cœur) S'abonner · 💬(cœur) Commenter** doit être **visible pendant les deux premières secondes** (t = 0 → 2,0 s). Les stickers sont des images détourées posées en POST (PAS d'emoji système rendus par la police) ; chaque sticker est légendé par un micro-label droit en DejaVu Sans Bold (« Like », « Abonne-toi », « Commente »).
...
### 5.3 Sticker PARTAGE au milieu de la vidéo (OBLIGATOIRE)
- À **t = durée/2** (± ajusté pour tomber entre deux vers, jamais par-dessus un vers en pleine lecture), faire apparaître le **sticker de partage mignon généré par l'IA** (`assets/icons/stickers/share_cute.png` — cœur/orbe de partage stylisé, glow cyan, traînée de mini-cœurs) : apparition en fondu + léger pulse (scale 1,0→1,06, ~0,9 Hz), durée d'affichage **~3 s**, puis fondu de sortie.
- Accompagné d'un micro-texte droit lisible : « Partage ⤴ » (DejaVu Sans Bold, jamais cursive).
- Le sticker est généré UNE FOIS (fond transparent ou détouré) et réutilisé sur tous les projets : `assets/icons/stickers/share_cute.png` (remplace l'ancien `assets/icons/share_daisky.png`). Si absent, le générer via IA (prompt : `cute kawaii share sticker, glowing heart with small arrow, cyan and amber neon glow, dark background, no text, no watermark`) puis détourer.
...
- **P. Pluie / Fraîcheur (v4.9)** : nuit de pluie rafraîchissante, palette bleu-teal froide + touches ambre chaudes, rideaux de pluie, reflets sur asphalte mouillé, bokeh de gouttes — suffixe canonique : `cool rain-soaked night, fresh blue-teal palette, falling rain streaks, wet asphalt mirror reflections, raindrop bokeh, atmospheric mist, electric cyan rim light, subtle warm amber accents, crushed blacks with cyan highlights, moody anime-seinen cinematic grading, 35mm film grain`.
- **S. Printemps ensoleillé (v4.9.1 — validée artiste sur *Yafoy t'es encore là*)** : paysages de printemps en plein soleil, prairies fleuries, cerisiers/fleurs en pétales portés par le vent, verts frais et ciel bleu lumineux, lumière dorée joyeuse — suffixe canonique : `bright sunny spring landscape, blooming meadows and cherry blossom trees, petals drifting in a warm breeze, fresh green fields, vivid blue sky with soft white clouds, golden sunlight, gentle lens flare, light bokeh, crisp clean air, joyful uplifting cinematic grading, 35mm film grain`.
...
2. Rendu : flux continu `ceil(durée_totale × 30)` frames, texte par fenêtres `d0/d1` (avance 0,03 s), overlays d'engagement (stickers CTA cœurs 0→2 s + sticker partage mi-vidéo, §5.2/§5.3) puis badge DSKY✓ posé en **dernier**, intro musical-only avec titre (0 → 1ʳᵉ voix), endcard à partir du fondu final.
...
6. **CTA 2 s** : frame à t=1,0 s → stickers cœurs Like/Abonne-toi/Commente présents (❤️💞 + variantes mignonnes) ; frame à t=3,5 s → disparus.
7. **Sticker partage mi-vidéo** : frame à t=durée/2 → sticker partage mignon visible ; absent 5 s avant/après sa fenêtre.
...
- **CTA** : stickers cœurs Like/S'abonner/Commenter (§5.2) visibles les **2 premières secondes**, rappel CTA en fin de teaser (dernière carte : « ❤️💞 Like · 🛎 Abonne-toi · 💬 Commente », stickers mignons, jamais emoji système).
...
5. **Suffixe technique canonique** (recopié tel quel) :
   ...
   - **Charte S (printemps ensoleillé)** : `bright sunny spring landscape, blooming meadows and cherry blossom trees, petals drifting in a warm breeze, fresh green fields, vivid blue sky with soft white clouds, golden sunlight, gentle lens flare, light bokeh, crisp clean air, joyful uplifting cinematic grading, 35mm film grain`
...
- **v4.9.3** — §5.2/§5.3/§17 : les CTA deviennent des **stickers cœurs mignons** générés (demande artiste) : **Like = ❤️💞** (double cœur scintillant), **Commenter = bulle kawaii avec cœur**, **S'abonner = clochette kawaii à cœur**, **Partager = cœur-orbe fléché avec traînée de mini-cœurs** ; famille de stickers générée UNE FOIS (`assets/icons/stickers/`) et réutilisée sur tous les projets (lyrics, covers si besoin, teaser). Remplace les icônes vectorielles 👍🔔💬 de la v4.9.
