...
**Étape 2 — Les images : 10 par format, DEUX formats (20 au total)** ( demande toujours si l'image du paysage sera la même avant de commencer et je pourrais avoir envie de te dire de changer, et aussi on peut générer 30 voir 40 images soit 10 par session, à toi de savoir comment demander)
