...
L = [
    ...
    (31.29, "Ovèor gogo tipé, tu fais danser la vie", "s27"),
    (33.58, "Wolof TechStein beat wê!", "s00"),
    (40.23, "Quand tu marches dans la rue, tout s'arrête", "s11"),
    (42.21, "Les gens se retournent, la terre s'arrête", "s11"),
    (44.17, "Tu as ce truc, ce truc qui fait bouger", "s12"),
    (46.18, "Ce truc qui fait danser, ce truc qui fait rêver", "s12"),
    ...
    (52.38, "Ayon dèkpè, tu es une œuvre d'art", "s14"),
    (54.47, "Ovèor gogo tipé, tu illumines le noir", "s14"),
    (56.65, "Danse, danse, danse avec moi", "s15"),
    (59.15, "Danse, danse, danse jusqu'au bout de la nuit", "s16"),
    (61.20, "Danse, danse, danse avec moi", "s15"),
    (63.19, "Danse, danse, danse, tu es la vie", "s16"),
    (65.43, "Ayon dèkpè, tu es trop jolie", "s26"),
    (67.95, "Ovèor gogo tipé, tu fais danser la nuit", "s28"),
    (72.85, "Ayon dèkpè, tu es trop jolie", "s25"),
    ...
    (99.33, "Je danse comme si le monde était à moi", "s17"),
    ...
    (107.58,"Ovèor gogo tipé, c'est ce qu'ils me crient", "s20"),
    ...
    (125.26,"Ovèor gogo tipé... tu es celle", "s23"),
    ...
    (134.94,"Ovèor gogo tipé, tu fais danser la nuit", "s28"),
