...
L = [
    ...
    (11.78, "Ayon dèkpè...", "s00"),
    (14.89, "Ovèor gogo tipé...", "s00"),
    (16.52, "Ayon dèkpè, tu es trop jolie", "s01"),
    (18.75, "Ovèor gogo tipé, tu fais danser la nuit", "s02"),
    (23.95, "Ayon dèkpè, tu es trop jolie", "s01"),
    (31.29, "Ovèor gogo tipé, tu fais danser la vie", "s01"),
    (33.58, "Wolof TechStein beat wê!", "s00"),
    (40.23, "Quand tu marches dans la rue, tout s'arrête", "s03"),
    (42.21, "Les gens se retournent, la terre s'arrête", "s03"),
    (44.17, "Tu as ce truc, ce truc qui fait bouger", "s03"),
    (46.18, "Ce truc qui fait danser, ce truc qui fait rêver", "s03"),
    (48.36, "Tes pas sont une mélodie, ton corps une symphonie", "s04"),
    (50.30, "Tu danses comme si le monde était à toi, toute la nuit", "s04"),
    (52.38, "Ayon dèkpè, tu es une œuvre d'art", "s04"),
    (54.47, "Ovèor gogo tipé, tu illumines le noir", "s04"),
    (56.65, "Danse, danse, danse avec moi", "s05"),
    (59.15, "Danse, danse, danse jusqu'au bout de la nuit", "s05"),
    (61.20, "Danse, danse, danse avec moi", "s05"),
    (63.19, "Danse, danse, danse, tu es la vie", "s05"),
    (65.43, "Ayon dèkpè, tu es trop jolie", "s01"),
    (67.95, "Ovèor gogo tipé, tu fais danser la nuit", "s02"),
    (72.85, "Ayon dèkpè, tu es trop jolie", "s01"),
    (76.06, "Ovèor gogo tipé, tu fais danser la vie", "s01"),
    (79.97, "Wolof TechStein beat wê!", "s00"),
    (97.55, "Je danse comme si demain n'existait pas", "s06"),
    (99.33, "Je danse comme si le monde était à moi", "s06"),
    (101.40,"Mes hanches parlent, mes pieds racontent", "s07"),
    (103.69,"Une histoire que seuls les danseurs comprennent", "s07"),
    (105.49,"Ayon dèkpè, c'est ce qu'ils me disent", "s07"),
    (107.58,"Ovèor gogo tipé, c'est ce qu'ils me crient", "s07"),
    (109.66,"Mais moi je danse pour moi, pour la nuit", "s06"),
    (111.67,"Pour la house, le break, pour la vie", "s06"),
    (113.68,"Danse, danse, danse avec moi", "s05"),
    (116.13,"Danse, danse, danse jusqu'au bout de la nuit", "s05"),
    (118.17,"Danse, danse, danse avec moi", "s05"),
    (120.31,"Danse, danse, danse, tu es la vie", "s05"),
    (122.35,"Ayon dèkpè... tu es belle", "s08"),
    (125.26,"Ovèor gogo tipé... tu es celle", "s08"),
    (127.09,"Qui fait bouger les murs, qui fait trembler le sol", "s08"),
    (129.36,"Qui transforme la piste en un champ de bataille", "s08"),
    (132.48,"Ayon dèkpè, tu es trop jolie", "s01"),
    (134.94,"Ovèor gogo tipé, tu fais danser la nuit", "s02"),
    (140.30,"Ayon dèkpè, tu es trop jolie", "s01"),
    (143.07,"Ovèor gogo tipé, tu fais danser la vie", "s01"),
    (147.29,"Wolof TechStein beat wê!", "s00"),
    (155.49,"Wolof TechStein beat wê...", "s09"),
    (173.50,"Ayon dèkpè...", "s09"),
    (181.09,"Ovèor gogo tipé...", "s09"),
    (187.28,"(Danse... danse...)", "s09"),
]
